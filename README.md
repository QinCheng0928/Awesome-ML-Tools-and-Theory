...
- [Awesome-ML-Tools-and-Theory](#Awesome-ML-Tools-and-Theory)
  - [Mathematical Foundations](./Mathematical-Foundations/)
    ...
    - [Statistics](./Mathematical-Foundations/Statistics.pdf)
  ...
  - [Tools](./Tools/)
    ...
    - [Pytorch](./Tools/Pytorch/)
      - [[Code] model manual](./Tools/Pytorch/model_manual.py)
      - [[Code] model with autograd](./Tools/Pytorch/model_with_autograd.py)
      - [[Code] model with nn module](./Tools/Pytorch/model_with_nn_module.py)

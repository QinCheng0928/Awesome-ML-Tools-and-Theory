...
from algorithm.MCExploringStarts import MCExploringStarts


def train(model_path):
    env = GridWorld()
    model = MCExploringStarts(
        env,
        gamma=0.9,
        iterations=100,
...
def main():
    ...
    if is_train:
        ...
        print("Evaluating the MC Exploring Starts model...")
        evaluate(model_path)

"""
Definition:
    nnn.LSTM(input_size, hidden_size, num_layers=1, batch_first=True)
    where:
...
Forward:
    ...
    output       : 
        ...
        (h_n, c_n) : The hidden state and cell state of each batch in the last layer. 
            h_n.Shape: (num_layers, batch_size, hidden_size)
            c_n.Shape: (num_layers, batch_size, hidden_size)
"""

if __name__ == "__main__":
    print("This is the README document of LSTM modol.")
